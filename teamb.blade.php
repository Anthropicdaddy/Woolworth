...
<body>
  ...
  <div class="common_header">
    <a href="javascript:history.back(-1)">
      <i class="fa-solid fa-arrow-left"></i> Team 2 Member
    </a>
  </div>
    ...
    <div class="common_card">
      <div class="layui-row">
        <div class="layui-col-xs6">
          <p class="team_value">{{$second_level_users->count()}}</p>
          <p class="team_label">People Invited</p>
        </div>
        <div class="layui-col-xs6">
          <p class="team_value">{{$second_level_users->where('investor', 1)->count()}}</p>
